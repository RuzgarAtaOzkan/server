...
// CLASS TYPES
import service_auth_init from 'api/services/auth';
import service_mail_init from 'api/services/mail';
import service_settings_init from 'api/services/settings';
import service_store_init from 'api/services/store';
import service_product_init from 'api/services/product';
