...
const au8 = (
  a: unknown,
  l?: number
): Bytes => // assert is Uint8Array (of specific length)
...
class Point {
  ...
  toRawBytes(isCompressed = true): Bytes {
...
const concatB = (...arrs: Bytes[]): Bytes => {
...
const bits2int_modN = (bytes: Bytes): bigint => {
...
const prepSig = (msgh: Hex, priv: PrivKey, opts: OptS = optS): BC => {
